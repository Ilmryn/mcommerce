...
public class ClientController {
	...
	/*
	 * Étape (1) Opération qui récupère la liste des produits et on les affichent
	 * dans la page d'accueil. Les produits sont récupérés grâce à ProduitsProxy On
	 * fini par rentourner la page Accueil.html à laquelle on passe la liste
	 * d'objets "produits" récupérés.
	 */
	@RequestMapping("/")
	...
	/*
	 * Étape (2) Opération qui récupère les détails d'un produit On passe l'objet
	 * "produit" récupéré et qui contient les détails en question à
	 * FicheProduit.html
	 */
	...
	/*
	 * Étape (3) et (4) Opération qui fait appel au microservice de commande pour
	 * placer une commande et récupérer les détails de la commande créée
	 */
	...
	public String passerCommande(@PathVariable int idProduit, @PathVariable Double montant, Model model) {
		...
		// On renseigne les propriétés de l'objet de type CommandeBean que nous avons
		// crée
	...
	/*
	 * Étape (5) Opération qui fait appel au microservice de paiement pour traiter
	 * un paiement
	 */
	...
	public String payerCommande(@PathVariable int idCommande, @PathVariable Double montantCommande, Model model) {
		...
		// On appel le microservice et (étape 7) on récupère le résultat qui est sous
		// forme ResponseEntity<PaiementBean> ce qui va nous permettre de vérifier le
		// code retour.
	...
	public String suiviExpedition(@PathVariable int idExpedition, Model model) {
		...
		ExpeditionBean expedition = expeditionProxy.recupererUneExpedition(idExpedition);
